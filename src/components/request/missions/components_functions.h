...
namespace components::request::missions::functions {
    ...
    auto constexpr inline ip_func = [](const boost::property_tree::ptree &json) {
    ...
    auto constexpr inline id_func = [](const boost::property_tree::ptree &json) {
        return json.get<size_t>("id");
    };

    auto constexpr inline mission_id_func = [](const boost::property_tree::ptree &json) {
        return json.get<size_t>("missionId");
    };

    auto constexpr inline mission_type_func = [](const boost::property_tree::ptree &json) {
    ...
    auto constexpr inline type_func = [](const boost::property_tree::ptree &json) {
        return json.get<std::string>("type");
    };

    auto constexpr inline mt1_func = [](const boost::property_tree::ptree &json) {
        const std::string hierarchy = "missionParams";
        return structures::mt1 {
                .param1 = json.get<std::string>(hierarchy + ".param1"),
                .param2 = json.get<double>(hierarchy + ".param2")
        };
    };

    auto constexpr inline mt2_func = [](const boost::property_tree::ptree &json) {
		const std::string hierarchy = "missionParams";
		return structures::mt2 {
    ...
    auto constexpr inline general_collection_func = [](Collection &collection, const boost::property_tree::ptree &json, bool is_optional) -> bool {
