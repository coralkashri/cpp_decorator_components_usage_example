...
//namespace components::support {
    ...
    class components_support_optional_child_not_set_exception : public std::exception {
    public:
        explicit components_support_optional_child_not_set_exception(const std::string &field_name) : field_name(field_name) {
