...
//namespace components::tools {
    ...
    inline RequestedT& components_tools_access_field(ComponentT &component) {
    ...
    template <typename RequestedT, typename ComponentT>
    RequestedT components_tools_access_copy_field(ComponentT &component) {
    ...
    RequestedT& components_tools_access_collection_element(ComponentT &component, size_t index) {
